...
class ClientStoreHome extends StatefulWidget {
  @override
  _ClientStoreHomeState createState() => _ClientStoreHomeState();
}

class _ClientStoreHomeState extends State<ClientStoreHome> {
  ...
  void registerNotification() {
    ...
    firebaseMessaging.subscribeToTopic("missing-persons");
