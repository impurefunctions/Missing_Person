...
import 'package:ecommerce/Widgets/Public_Drawer.dart';
...
class Public_Store extends StatefulWidget {
  @override
  _Report_StoreState createState() => _Report_StoreState();
}

class _Report_StoreState extends State<Public_Store> {
                ...
                builder: (context, snapshot) {
                  return !snapshot.hasData
                    ...
                    itemBuilder: (context, index) {
                      ...
                      model.productId =snapshot.data.documents[index].documentID;
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  if(model.lastSeen != null)Text(DateFormat.yMMMd().format(model.lastSeen),
                                      style: AppTheme.h6Style.copyWith(
                                        fontSize: 14,
                                        color: Colors.red,
                                      )),
